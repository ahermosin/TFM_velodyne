...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/alberto/workspaces/workspace14diciembre/src/EKF)
  set(ekf_DEVEL_PREFIX /home/alberto/workspaces/workspace14diciembre/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/alberto/workspaces/workspace14diciembre/install)
...
if(NOT "/home/alberto/workspaces/workspace14diciembre/src/EKF/src/include " STREQUAL " ")
  set(ekf_INCLUDE_DIRS "")
  set(_include_dirs "/home/alberto/workspaces/workspace14diciembre/src/EKF/src/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alberto/workspaces/workspace14diciembre/src/EKF/${idir}'.  ${_report}")
    endif()
